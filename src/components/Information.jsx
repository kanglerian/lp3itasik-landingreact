          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            {youtube.length > 0 ? (
              ...
              <>
                ...
                <div className="w-full md:w-1/2">
                  <h5 className="font-bold text-2xl md:text-3xl" data-aos="fade-up" data-aos-delay="100">LP3I Tasikmalaya – Cover Condong Pada Mimpi</h5>
                  <p className="text-sm text-gray-600 mt-3" data-aos="fade-up" data-aos-delay="200">Video ini berisi tentang pendidikan vokasi di LP3I Tasikmalaya mulai dari kegiatan Pengenalan Lingkungan Kampus, kegiatan praktek akuntansi, praktek otomotif, praktek informatika, praktek manajemen perkantoran, dan proses penempatan kerja yang menjadi salah satu program unggulan di LP3I.</p>
                  <a href="#" data-aos="fade-up" data-aos-delay="300" className="transition ease-in-out duration-300 inline-block py-2 px-4 text-sm mt-5 text-white bg-sky-500 hover:bg-sky-600 rounded">Lihat selengkapnya</a>
                  <div className="mt-5 flex justify-center">
