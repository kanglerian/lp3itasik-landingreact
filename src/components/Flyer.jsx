  ...
  const handleSend = async () => {
    ...
    .then((res) => {
      ...
      if(res.data.status){
        ...
        handleWhatsapp('6281286501015@c.us');
      }else{
      ...
      {isVisible && (
        <div id="myModal" className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-gray-900 bg-opacity-75 flex items-center justify-center h-screen w-full px-5">
            <div data-aos-duration="1000" data-aos-delay="1000" className="w-full md:w-2/3 lg:w-1/3 bg-slate-100 rounded-xl p-5 max-h-screen overflow-y-auto">
