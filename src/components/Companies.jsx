    ...
    <section className="my-10">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center space-x-10">
          <img src={logoKampusMerdeka} alt="Kampus Merdeka" className="inline w-32" />
          <img src={logoMsib} alt="MSIB" className="inline w-32" />
          <img src={logoTut} alt="Tut Wuri Handayani" className="inline w-32" />
        </div>
