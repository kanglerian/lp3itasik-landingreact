        ...
        <section id="about">
          ...
          <div className='flex flex-col md:flex-row items-center gap-5 mx-4'>
            <div className='w-full md:w-2/6 order-2 md:order-none space-y-4'>
              <div className='space-y-1'>
                <h1 className='text-2xl md:text-4xl font-bold'>{currentLanguage == 'en' ? 'C&P Team' : 'Tim C&P'}</h1>
          ...
          <div className='space-y-6 px-4 mt-10'>
            <div className='text-center space-y-2'>
              <h1 className='font-bold text-2xl md:text-3xl'>{currentLanguage == 'en' ? 'Job Placement Documentation' : 'Dokumentasi Penempatan Kerja'}</h1>
              <p className='text-gray-700 text-sm md:text-base' data-aos-delay="20">
          ...
          <div className='space-y-6 px-4 mt-10'>
            <div className='text-center space-y-2'>
              <h1 className='font-bold text-2xl md:text-3xl'>{currentLanguage == 'en' ? 'Relations Companies' : 'Perusahaan Relasi'}</h1>
              <p className='text-gray-700 text-sm md:text-base' data-aos-delay="20">
