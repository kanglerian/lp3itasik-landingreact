    ...
    <Suspense fallback={renderLoader()}>
      ...
      <section className='container mx-auto px-4 py-8'>
        ...
        <div className='mt-6 text-center'>
          ...
          <a href='https://api.whatsapp.com/send?phone=6281313608558&text=Hallo%20Kak,%20Boleh%20minta%20informasi%20Pendaftaran%20Mahasiswa%20Politeknik%20LP3I%20Kampus%20Tasikmalaya%3F' target='_blank' className='inline-block bg-green-500 px-8 py-2 rounded-lg text-white mt-3'><i className="fa-brands fa-whatsapp mr-1" /> Daftar Sekarang</a>
        </div>
      </section>
